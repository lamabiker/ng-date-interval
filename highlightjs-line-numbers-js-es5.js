(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["highlightjs-line-numbers-js"], {
  ...
  /***/
  function node_modulesHighlightjsLineNumbersJsSrcHighlightjsLineNumbersJs(module, exports) {
      ...
      function addLineNumbersBlockFor(inputHtml, firstLineIndex) {
        ...
        if (lines.length > firstLineIndex) {
          ...
          for (var i = 0, l = lines.length; i < l; i++) {
            html += format('<tr>' + '<td class="{0} {1}" {3}="{5}">' + '<div class="{2}" {3}="{5}"></div>' + '</td>' + '<td class="{0} {4}" {3}="{5}">' + '{6}' + '</td>' + '</tr>', [LINE_NAME, NUMBERS_BLOCK_NAME, NUMBER_LINE_NAME, DATA_ATTR_NAME, CODE_BLOCK_NAME, i + 1, lines[i].length > 0 ? lines[i] : ' ']);
          }
...
//# sourceMappingURL=highlightjs-line-numbers-js-es5.js.map